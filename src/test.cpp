...
int main()
{
  ...
  const r1cs_ppzksnark_keypair<default_r1cs_ppzksnark_pp> keypair = malicious_r1cs_ppzksnark_generator<default_r1cs_ppzksnark_pp>(constraint_system);
  ...
  bool verified = malicious_r1cs_ppzksnark_verifier<default_r1cs_ppzksnark_pp>(keypair.vk, pb.primary_input(), proof);
